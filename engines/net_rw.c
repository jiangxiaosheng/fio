...
static struct fio_option options[] = {
	{
		...
		.off1	= offsetof(struct net_rw_options, dummy),
		.help	= "Set dummy",
		.category = FIO_OPT_C_ENGINE, /* always use this */
		.group	= FIO_OPT_G_NET_RW, /* this can be different */
	},
	{
		.name	= NULL,
	},
...
struct ioengine_ops ioengine = {
	...
	.options	= options,
	.option_struct_size	= sizeof(struct net_rw_options),
};
